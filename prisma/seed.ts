...
async function main() {
  ...
  const tenant = await prisma.tenant.create({
    data: {
      ...
      notifySound: 1,
      receiptHeader: 'Cảm ơn quý khách đã ghé thăm !',
      receiptFooter: 'Hẹn gặp lại quý khách !',
      operatingHours: {
        monday: { slots: [{ open: '09:00', close: '22:00' }], isOpen: true },
        tuesday: { slots: [{ open: '09:00', close: '22:00' }], isOpen: true },
        wednesday: { slots: [{ open: '09:00', close: '22:00' }], isOpen: true },
        thursday: { slots: [{ open: '09:00', close: '22:00' }], isOpen: true },
        friday: { slots: [{ open: '09:00', close: '22:00' }], isOpen: true },
        saturday: { slots: [{ open: '09:00', close: '22:00' }], isOpen: true },
        sunday: { slots: [{ open: '09:00', close: '22:00' }], isOpen: true },
      },
      payosApiKey: 'c9005c1c-5ebc-4989-bd06-2e5205a53372',
      payosChecksumKey: 'a2066f010721b5dd86ee055d90c7d93fa721f493ada136dcf81e882326c1e4fb',
      payosClientId: 'd825480f-9ed6-46ab-b03e-4660858d6c11',
      ...
      onboardingDraft: {
        ...
        payment: {
          payos_api_key: 'c9005c1c-5ebc-4989-bd06-2e5205a53372',
          payos_client_id: 'd825480f-9ed6-46ab-b03e-4660858d6c11',
          payos_checksum_key: 'a2066f010721b5dd86ee055d90c7d93fa721f493ada136dcf81e882326c1e4fb',
        },
        tax_charge: {
          tax_rate: 10,
          tax_label: 'VAT',
